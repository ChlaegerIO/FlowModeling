...
%% tuning parameters
% ------------------------------------------------------------------------
lambda = 0.25;                     % sparsification knob for SINDy
split = 0.5;                        % split between the train and test data
...
makeVideo(strcat(path_figure,'lambda',num2str(lambda),'_until',num2str(until),'_S2'), X1_pred, video.Height, video.Width);
fprintf('prediction 1 done \n');
...
makeVideo(strcat(path_figure,'lambda',num2str(lambda),'_until',num2str(until),'_St'), X1_pred, video.Height, video.Width);
fprintf('prediction 2 done \n');
